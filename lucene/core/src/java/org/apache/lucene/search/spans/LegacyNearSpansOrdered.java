 ...
 */
public class LegacyNearSpansOrdered extends ConjunctionSpans {
  ...
  public LegacyNearSpansOrdered(int allowedSlop, List<Spans> subSpans) throws IOException {
    this(allowedSlop, subSpans, null);
  }

  public LegacyNearSpansOrdered(int allowedSlop, List<Spans> subSpans, List<Spans> shingles) throws IOException {
    super(subSpans, shingles);
